...
parser = argparse.ArgumentParser(description="Calculate volume of a Cylinder")   # Container to hall arguments
...
if __name__ == "__main__":
    ...
    if args.quiet:
        ...
        print ("Volume of the Cylinder with %s and height %s is %s" % (args.radius, args.height, volume))
    else:
